# -*- coding: utf-8 -*-
"""
Created on Fri Oct 30 20:02:14 2020
...
#Implement the function isIn(char, aStr) which implements the above idea recursively to 
#test if char is in aStr. char will be a single character and aStr will be a string that is in alphabetical order. 
...
def isIn(char, aStr):
    ...
    # so recursively seach on the last half of aStr
